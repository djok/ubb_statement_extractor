...
└──────┬──────┘      └────────┬─────────┘      └────────┬────────┘
  ...
  └─────────┘      email      │                         │
                              ...
                              └─────────────►│  Webhook API     │
                                             ...
                                             └────────┬─────────┘
                                                      │
                                    4. Разархивира ZIP с парола
                                    5. Извлича данни от PDF
                                                      │
                                                      ▼
                              ┌────────────────────────────────────┐
                              │                                    │
...
**Накратко:** ОББ изпраща ежедневно извлечение като ZIP архив с парола на email. Системата автоматично получава, разархивира, парсва PDF-а и записва транзакциите в BigQuery за анализ.
...
```bash
git clone https://github.com/djok/ubb_statement_extractor.git
cd ubb_statement_extractor
```
